        ...
        for i in range(x):
            ...
            for y in range(x - 1):
                ...
                for j in range(0, x - y - 1):
                    ...
                    # возрастанию значений снизу
                    # вверх, а каждый чётный столбец по возрастанию значений
                    # сверху вниз, записываем противоположные сравнения в каждое
                    # из условий.
                    if i % 2 == 1:
                        if massiv2[j][i] > massiv2[j + 1][i]:
                            massiv2[j][i], massiv2[j + 1][i] = massiv2[j + 1][
                                                                   i], \
                                                               massiv2[j][i]
                    if i % 2 == 0:
                        if massiv2[j][i] < massiv2[j + 1][i]:
