...
c = 100
print(
    "1.Удалим из списка элемент с индексом k, сдвинув влево все элементы, "
    "стоящие правее элемента с индексом k.\n "
    "Ввод:\n", my_list, "\n", k, "\n Вывод:\n",
    hillel.delete_by_index(my_list, k))
print(
    "2.Вставим в список на позицию с индексом k значение C, сдвинув все "
    "элементы, с индексом большим k, вправо.\n "
    "Ввод:\n", my_list, "\n", k, "\n", c, "\n Вывод:\n",
    hillel.insert_number(my_list, k, c))
print(
    "3.Подсчитаем сколько уникальных чисел содержится одновременно как в "
...
print(
    "1.Для каждого слова из заданного текста подсчитаем, сколько раз оно "
    "встречалось в этом тексте.\n "
    "Ввод:\n", my_text, "\n Вывод:\n", hillel.word_frequency(my_text))
print(
    "2.Выведем слово, которое чаще всего встречается в трёх различных строках."
    "\n Ввод:\n", my_text, "\n", my_text1, "\n", my_text2, "\n Вывод:\n",
    hillel.maximum_number_of_word_mentions(my_text, my_text1, my_text2))
print(
    "3.Из заданного списка чисел определим сколько в нём встречается различных "
    "чисел.\n Ввод:\n", my_list2, "\n Вывод:\n",
    hillel.quantity_of_different_numbers(my_list2))
print(
    "4.Задаются два списка чисел. Определим количество чисел, содержащихся как "
...
b = 100
print(
    "1.Проверим есть ли в списке 2 числа, сума которых еквивалентна числу "
    "переданому 2м параметром.\n Ввод:\n",
    my_list4, "\n", num, "\n Вывод:\n", hillel.two_sum(my_list4, num))
print(
    "2.Возьмём список с числами и возведём каждое число списка в квадрат.\n "
    "Ввод:\n",
    my_list4, "\n Вывод:\n", hillel.list_numbers_squared(my_list4))
print(
    "3.Найдём простые числа в дипазоне заданным 2мя аргументами чисел.\n "
    "Ввод:\n", a, "\n", b, "\n Вывод:")
...
print(
    "1.Выведем заданное количество членов треугольной последовательности.\n "
    "Ввод:\n", 5, "\n Вывод:")
print(hillel.triangle_sequence(5))
print(
    "2.Определим количество последовательностей из 0 и 1, где два нуля не "
